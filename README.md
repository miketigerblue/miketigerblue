...
Thirty years across the infrastructure stack, from standing up Bermuda's first commercial internet in the 1990s to serving as CTO at a national carrier, then at **QuoVadis** (now DigiCert) — where I ran a live migration of five CA roots and 10k+ government and tier-1 enterprise certificates with zero downtime. More recently: senior systems engineering on CNI-grade IIoT platforms at **Motion Applied**, building trust roots, hardened Linux kernels, and PKI enrolment flows for critical infrastructure at the edge.
